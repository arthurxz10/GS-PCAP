...
- [x] Matriz `dados_missao` com 8 ciclos (mínimo exigido: 6)
- [x] 5 colunas por ciclo na ordem correta
- [x] Lista `areas_monitoradas`
- [x] 12 funções (mínimo exigido: 5)
- [x] Estrutura de repetição (`for`) percorrendo os ciclos
- [x] Estruturas condicionais (`if/elif/else`) gerando alertas
